...
- [mandos](https://www.recompile.se/mandos), a system for allowing servers with encrypted root file systems to reboot unattended and/or remotely. Available as [services.mandos](option.html#opt-services.mandos.enable).
